...
from . import dct_butterfly_torch as dct_b
from .feature_extraction import feature_extraction, temporal_feature_extraction
from .frame_to_block import frame_to_block
from .plot_block_info_EVCA import plot_block_info_EVCA
from .write_block_info import write_block_info


def EVCA(args: argparse.Namespace, input_list: Iterable[str], device) -> None:
